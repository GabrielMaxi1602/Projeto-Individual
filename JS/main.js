function mudanca_tela(){
    var personagens = ['url(./imgs/yoru.jpg)', 'url(./imgs/raze.png)', 'url(./imgs/skye.jpg)']

    var cor_borda = ['#00aeff', '#dde909', '#009d03']

    var blor = ['#00ccff 3px 3px 30px 5px','#efbd08 3px 3px 30px 5px','#1d6201 3px 3px 30px 5px']
    var cor = ['#000ba1','#efbd08','#1d6201']
